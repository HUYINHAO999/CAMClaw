...
- LLM calls, prompt contracts, model response parsing, and natural-language planning belong in the Python backend. The C++ Qt/CAM core consumes reviewed structured artifacts and executes CAM behavior.
